...
(function(w) {
    ...
    function shareText(score) {
        ...
        if (mode === MODE_ENDLESS) {
            if (score <= 5) return '反V大将军';
            if (score <= 8) return '反V大手子';
            if (score <= 10)  return '楠天主人';
            return '楠天亲爸';
        } else {
            if (score <= 49) return '反V大将军';
            if (score <= 99) return '反V大手子';
            if (score <= 149) return '楠天主人';
            return '楠天亲爸';
        }
    }
    ...
    function initSetting() {
        ...
        document.getElementsByTagName("title")[0].innerText = cookie("title") ? cookie("title") : "殴打楠天";
        if (cookie("keyboard")) {
